 ...
 * @date   January, 2010
 * @brief  The Ets-Code calls the different libraries,
 ...
 * Every time a complete spectrum is parsed (with BEGIN IONS and END IONS lines), it gets passed in a temporary file to Directag/Pepnovo in <tt> run_programs</tt>.
...
private:
    ...
    /** call gmm-bic and find the quantile, selector sets the number of gaussians.
